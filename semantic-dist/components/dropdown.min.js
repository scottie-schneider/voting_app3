      ...
      return (
        s.each(function(f) {
          ...
          (y = {
            ...
            destroy: function() {
              y.verbose('Destroying previous dropdown', P),
                y.remove.tabbable(),
                P.off(F).removeData(M),
                W.off(F),
                r.off(w),
            ...
            observeChanges: function() {
              'MutationObserver' in t &&
                ((S = new MutationObserver(y.event.select.mutation)),
                (C = new MutationObserver(y.event.menu.mutation)),
                y.debug('Setting up mutation observer', S, C),
                y.observe.select(),
                y.observe.menu());
            },
            disconnect: {
            ...
            observe: {
              select: function() {
                y.has.input() &&
                  S.observe(U[0], { childList: !0, subtree: !0 });
              },
              menu: function() {
                y.has.menu() && C.observe(W[0], { childList: !0, subtree: !0 });
              },
            },
            create: {
              id: function() {
            ...
            setup: {
              ...
              layout: function() {
                P.is('select') && (y.setup.select(), y.setup.returnedObject()),
                  ...
                  U.parent(O.dropdown).length > 0
                    ...
                    : (y.debug('Creating entire dropdown from select'),
                      ...
                      U.hasClass(T.multiple) &&
                        U.prop('multiple') === !1 &&
                        (y.error(V.missingMultiple), U.prop('multiple', !0)),
                      U.is('[multiple]') && y.set.multiple(),
                      U.prop('disabled') &&
                        (y.debug('Disabling dropdown'), P.addClass(T.disabled)),
                      U.removeAttr('class')
                        .detach()
                        .prependTo(P)),
                  y.refresh();
            ...
            show: function(t) {
              if (
                ...
                !y.can.show() &&
                  y.is.remote() &&
                  (y.debug('No API results retrieved, searching before show'),
                  y.queryRemote(y.get.query(), y.show)),
            ...
            bind: {
              ...
              touchEvents: function() {
                y.debug(
                  ...
                  y.is.searchSelection() ||
                    (y.is.single() &&
                      P.on('touchstart' + F, y.event.test.toggle)),
                  W.on('touchstart' + F, O.item, y.event.item.mouseenter);
              },
              keyboardEvents: function() {
                y.verbose('Binding keyboard events'),
                  P.on('keydown' + F, y.event.keydown),
                  y.has.search() &&
                    P.on(y.get.inputEvent() + F, O.search, y.event.input),
                  y.is.multiple() &&
                    r.on('keydown' + w, y.event.document.keydown);
              },
              inputEvents: function() {
                y.verbose('Binding input change events'),
                  P.on('change' + F, O.input, y.event.change);
              },
              mouseEvents: function() {
                y.verbose('Binding mouse events'),
                  y.is.multiple() &&
                    P.on('click' + F, O.label, y.event.label.click).on(
                      'click' + F,
                      O.remove,
                      y.event.remove.click
                    ),
                  y.is.searchSelection()
                    ? (P.on('mousedown' + F, y.event.mousedown)
                      ...
                      y.is.multiple() && P.on('click' + F, y.event.click))
                    : ('click' == A.on
                        ? P.on('click' + F, O.icon, y.event.icon.click).on(
                            'click' + F,
                            y.event.test.toggle
                          )
                        : 'hover' == A.on
                        ? P.on('mouseenter' + F, y.delay.show).on(
                            'mouseleave' + F,
                            y.delay.hide
                          )
                        : P.on(A.on + F, y.toggle),
                      P.on('mousedown' + F, y.event.mousedown)
                        .on('mouseup' + F, y.event.mouseup)
                        .on('focus' + F, y.event.focus),
                      y.has.menuSearch()
                        ? P.on('blur' + F, O.search, y.event.search.blur)
                        : P.on('blur' + F, y.event.blur)),
            ...
            queryRemote: function(t, n) {
              ...
              P.api('get request') || y.setup.api(),
                (i = e.extend(!0, {}, i, A.apiSettings)),
                P.api('setting', i).api('query');
            },
                ...
                $.each(function() {
                  ...
                  if ('both' == A.match || 'value' == A.match) {
                    if (
                      ...
                      return a.push(this), !0;
                    if ('exact' === A.fullTextSearch && y.exactSearch(n, i))
                      return a.push(this), !0;
                    if (A.fullTextSearch === !0 && y.fuzzySearch(n, i))
                      return a.push(this), !0;
                  }
                })),
            ...
            focusSearch: function(e) {
              y.has.search() &&
                !y.is.focusedOnSearch() &&
                (e
                  ? (P.off('focus' + F, O.search),
                    j.focus(),
                    P.on('focus' + F, O.search, y.event.search.focus))
                  : j.focus());
            },
                    ...
                    t == I.leftArrow
                      ...
                      ? r
                        ...
                        : h &&
                          !r &&
                          t == I.backspace &&
                          (y.verbose('Removing last label on input backspace'),
            ...
            get: {
              ...
              value: function() {
                var t = U.length > 0 ? U.val() : P.data(D.value),
            ...
            save: {
              ...
              defaultValue: function() {
                ...
                y.verbose('Saving default value as', e),
                  P.data(D.defaultValue, e);
              },
              defaultText: function() {
                var e = y.get.text();
                y.verbose('Saving default text as', e),
                  P.data(D.defaultText, e);
              },
              placeholderText: function() {
                var e;
                A.placeholder !== !1 &&
            ...
            set: {
              ...
              tabbable: function() {
                y.is.searchSelection()
                  ...
                  : (y.debug('Added tabindex to dropdown'),
                    P.attr('tabindex') === i &&
                      (P.attr('tabindex', 0), W.attr('tabindex', -1)));
              },
              ...
              value: function(e, t, n) {
                ...
                if (o) {
                  ...
                  y.verbose('Storing value in metadata', a, U),
                    a !== s && P.data(D.value, r);
                A.fireOnInit === !1 && y.is.initialLoad()
              ...
              value: function(t, n, i) {
                ...
                return '' === t
                  ...
                  : (e.isArray(o)
                    ...
                    y.has.selectInput()
                      ? y.can.extendSelect() &&
                        (y.debug('Adding value to select', t, a, U),
                        y.add.optionValue(t))
            ...
            remove: {
              ...
              optionValue: function(e) {
                ...
                i &&
                  ...
                  S && S.observe(U[0], { childList: !0, subtree: !0 }));
              },
              message: function() {
              ...
              activeLabels: function(e) {
                (e = e || P.find(O.label).filter('.' + T.active)),
