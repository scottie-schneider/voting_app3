          ...
          a.each(function() {
            ...
            (F = {
              initialize: function() {
                F.get.settings(),
                  d
                    ? (E === i && F.instantiate(), F.invoke(c))
                    : (E !== i && E.invoke('destroy'),
              ...
              bindEvents: function() {
                F.verbose('Attaching form events'),
                  O.on('submit' + P, F.validate.form)
                    .on('blur' + P, k.field, F.event.field.blur)
                    .on('click' + P, k.submit, F.submit)
                    .on('click' + P, k.reset, F.reset)
                    .on('click' + P, k.clear, F.clear),
                  x.keyboardShortcuts &&
                    O.on('keydown' + P, k.field, F.event.field.keydown),
                  m.each(function() {
                    var t = e(this),
                      n = t.prop('type'),
              ...
              removeEvents: function() {
                O.off(P), m.off(P), v.off(P), m.off(P);
              },
              event: {
                field: {
                  keydown: function(t) {
                    ...
                    i == s.escape &&
                      ...
                      t.ctrlKey ||
                        ...
                        a ||
                        (j ||
                          (n.one('keyup' + P, F.event.field.keyup),
                          F.submit(),
              ...
              event: {
                ...
                keydown: function(e) {
                  ...
                  t == n.escape
                    ...
                    ? (A = !1)
                    : (m.verbose('Enter/space key pressed, toggling checkbox'),
                      m.toggle(),
                      (A = !0));
                },
                keyup: function(e) {
        ...
        return (
          r.each(function(p) {
            ...
            (k = {
              ...
              destroy: function() {
                k.verbose('Destroying previous dropdown', M),
                  k.remove.tabbable(),
              ...
              show: function(t) {
                if (
                  ...
                  !k.can.show() &&
                    k.is.remote() &&
                    (k.debug('No API results retrieved, searching before show'),
                    k.queryRemote(k.get.query(), k.show)),
              ...
              bind: {
                ...
                touchEvents: function() {
                  k.debug(
                    ...
                    k.is.searchSelection() ||
                      (k.is.single() &&
                        M.on('touchstart' + z, k.event.test.toggle)),
                    Q.on('touchstart' + z, D.item, k.event.item.mouseenter);
                },
                keyboardEvents: function() {
                  k.verbose('Binding keyboard events'),
                    M.on('keydown' + z, k.event.keydown),
                    k.has.search() &&
                      M.on(k.get.inputEvent() + z, D.search, k.event.input),
                    k.is.multiple() &&
                      s.on('keydown' + y, k.event.document.keydown);
                },
                inputEvents: function() {
                  k.verbose('Binding input change events'),
                    M.on('change' + z, D.input, k.event.change);
                },
                mouseEvents: function() {
                  k.verbose('Binding mouse events'),
                    k.is.multiple() &&
                      M.on('click' + z, D.label, k.event.label.click).on(
                        'click' + z,
                        D.remove,
                        k.event.remove.click
                      ),
                    k.is.searchSelection()
                      ? (M.on('mousedown' + z, k.event.mousedown)
                        ...
                        k.is.multiple() && M.on('click' + z, k.event.click))
                      : ('click' == S.on
                          ? M.on('click' + z, D.icon, k.event.icon.click).on(
                              'click' + z,
                              k.event.test.toggle
                            )
                          : 'hover' == S.on
                          ? M.on('mouseenter' + z, k.delay.show).on(
                              'mouseleave' + z,
                              k.delay.hide
                            )
                          : M.on(S.on + z, k.toggle),
                        M.on('mousedown' + z, k.event.mousedown)
                          .on('mouseup' + z, k.event.mouseup)
                          .on('focus' + z, k.event.focus),
                        k.has.menuSearch()
                          ? M.on('blur' + z, D.search, k.event.search.blur)
                          : M.on('blur' + z, k.event.blur)),
                  ...
                  X.each(function() {
                    ...
                    if ('both' == S.match || 'value' == S.match) {
                      if (
                        ...
                        return o.push(this), !0;
                      if ('exact' === S.fullTextSearch && k.exactSearch(n, i))
                        return o.push(this), !0;
                      if (S.fullTextSearch === !0 && k.fuzzySearch(n, i))
                        return o.push(this), !0;
                    }
                  })),
                ...
                k.has.search() &&
                  ...
                  (e
                    ? (M.off('focus' + z, D.search),
                      V.focus(),
                      M.on('focus' + z, D.search, k.event.search.focus))
                    : V.focus());
              },
                ...
                keydown: function(e) {
                  ...
                  if (n) {
                    var i,
                      ...
                      p =
                        t == P.delimiter && S.allowAdditions && k.is.multiple(),
                      h =
                        S.allowAdditions &&
                        S.hideAdditions &&
                        (t == P.enter || p) &&
                    ...
                    if (
                      ...
                      if (
                        ((t == P.enter || p) &&
                          (t == P.enter && m && f && !S.allowCategorySelection
                            ? (k.verbose(
                      ...
                      t == P.pageUp && (k.scrollPage('up'), e.preventDefault()),
                        t == P.pageDown &&
            ...
            (C = {
              ...
              event: {
                start: function(t) {
                  ...
                  clearTimeout(C.hideTimer),
                    M || (C.showTimer = setTimeout(C.show, n));
                },
                end: function() {
              ...
              bind: {
                events: function() {
                  C.debug('Binding popup events to module'),
                    ...
                    'hover' == w.on &&
                      d &&
                      F.on('touchstart' + P, C.event.touchstart),
                    C.get.startEvent() &&
                      F.on(C.get.startEvent() + P, C.event.start).on(
                        C.get.endEvent() + P,
                        C.event.end
                      ),
                ...
                popup: function() {
                  C.verbose(
                    ...
                    r &&
                      C.has.popup() &&
                      r
                        .on('mouseenter' + P, C.event.start)
                        .on('mouseleave' + P, C.event.end);
                },
                close: function() {
                  (w.hideOnScroll === !0 ||
        ...
        return (
          r.each(function() {
            ...
            (w = {
                ...
                containScroll: function(e) {
                  I.scrollTop <= 0 && (I.scrollTop = 1),
                    I.scrollTop + I.offsetHeight >= I.scrollHeight &&
                      (I.scrollTop = I.scrollHeight - I.offsetHeight - 1);
                },
                scroll: function(t) {
              ...
              show: function(t) {
                if (
                  ...
                  if (
                    (w.refreshSidebars(),
                    k.overlay &&
                      (w.error(P.overlay), (k.transition = 'overlay')),
                    w.refresh(),
                    w.othersActive())
                  )
                    if (
              ...
              p
                ? (M === i && w.initialize(), w.invoke(g))
                : (M !== i && w.invoke('destroy'), w.initialize());
          }),
          a !== i ? a : this
        );
      }),
